...
Εξαιτίας αυτής της ανισορροπίας, η χρήση της απλής Ακρίβειας *(Accuracy)* θα μπορούσε να οδηγήσει σε παραπλανητικά συμπεράσματα. Για να αντιμετωπιστεί αυτό, υιοθετήθηκαν οι σταθμισμένες *(Weighted)*  μετρικές:
...
8. **Διαμερισμός 80-20:** Train 4.424, Test 1.107· η κατανομή κλάσεων διατηρείται stratified.
