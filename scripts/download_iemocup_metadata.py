"""
Download and extract dataset from IEMOCAP Emotion Speech Database Kaggle
"""
import sys
import zipfile
import tarfile
...
def main():
    try:
        ...
        target_dir = Path("datasets/iemocup")
        target_dir.mkdir(parents=True, exist_ok=True)
        
        print("Downloading...")
        dataset_path = kagglehub.dataset_download("samuelsamsudinng/iemocap-emotion-speech-database")
