...
# ==============================
DATASET_NAME = "cremad"
AUDIO_DIR = "/workspace/datasets/cremad/AudioWAV"
OUTPUT_DIR = "/workspace/processed/features"

FEATURES_CSV = OUTPUT_DIR + "/cremad/cremad_features.csv"
REPORT_TXT = OUTPUT_DIR + "/cremad/cremad_feature_report.txt"
...
with open(REPORT_TXT, "w") as f:
    ...
    f.write(f"Total metadata samples: {len(wav_files)}\n")
